...
<tr>
       ...
       <tr><td>&nbsp;&nbsp;&nbsp;&nbsp;</td> </tr>
       <tr><td style="font-family: cursive;">Cutlery & Crokery</a> </tr>
       <tr><td>&nbsp;&nbsp;&nbsp;&nbsp;</td> </tr>
...
?>
<td div id="gobutton">
<img src="img/tea.jpg" height="209px" width="300"/>
<br />
<br />
    <h6>Borosil Piccolo Cup & Saucer Set</h6>
    <h6>Rs.1360</h6>
    <br />
    <h6>
    <ul width="40%">
...
if(isset($_GET['b6']))
{
    $link=mysql_connect("localhost","root","");
mysql_select_db("stp_2014");
$q="select status,price,pro_id from products where pro_id='cnc6'";
$rec=mysql_query($q);
if($res=mysql_fetch_row($rec))
{
    if ($res[0]=='on' || $res[0]=='On'|| $res[0]=='ON')
