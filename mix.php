...
<tr>
       ...
       <tr><td>&nbsp;&nbsp;&nbsp;&nbsp;</td> </tr>
       <tr><td style="font-family: cursive;">Mixer/Juicer/Grinder</a> </tr>
       <tr><td>&nbsp;&nbsp;&nbsp;&nbsp;</td> </tr>
...
<td div id="gobutton">
<img src="img/phil.jpeg" height="209px" width="300"/>
<br />
<br />
    <h6>Philips Mixer Grinder</h6>
    <h6>Rs.4895</h6>
    <br />
    <h6>
    <ul width="40%">
        <li type="square" >550 W consumption</li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <li type="square" >Blending feature</li></li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <li type="square" >Chutney grinding feature</li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
     </ul>
    </h6>
...
$q="select status,price,pro_id from products where pro_id='mix1'";
$rec=mysql_query($q);
...
?>
<td div id="gobutton">
<img src="img/smix.jpeg" height="220px" width="45%"/>
<br />
<br />
