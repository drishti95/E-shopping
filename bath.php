...
var items = new Array();
    items[0]="<a href='link.htm'><img src='img/refri.jpg' height='250' width='900' border='0' /></a>"; //a linked image
    items[1]="<a href='link.htm' ><img src='img/sale.jpg' height='250' width='900' border='0' /></a>"; //a linked image
    items[2]="<a href='link.htm'><img src='img/homet.jpg' height='250' width='900' border='0' /></a>"; //a linked image
...
?>
<td div id="gobutton">
<img src="img/curtain.jpeg" height="210" width="65%"/>
<br />
<br />
    <h6>Truhome Shower Curtain</h6>
    <h6>Rs.499</h6>
    <br />
    <h6>
    <ul width="40%">
        <li type="square" style="margin-right:;">Polyester</li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
       </ul>
           </h6>
...
if(isset($_GET['b2']))
{
    $link=mysql_connect("localhost","root","");
mysql_select_db("stp_2014");
$q="select status,price,pro_id from products where pro_id='cur2'";
$rec=mysql_query($q);
if($res=mysql_fetch_row($rec))
{
    if ($res[0]=='on' || $res[0]=='On'|| $res[0]=='ON')
...
<tr>
<td div id="gobutton">
<img src="img/curt.jpeg" height="299px" width="288"/>
    <h6>Bianca Arctic Shower Curtain</h6>
    <h6>Rs.475</h6>
    <br />
    <h6>
    <ul width="40%">
        <li type="square" >Polyester</li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <li type="square" >Do not iron</li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
if(isset($_GET['b5']))
{
    $link=mysql_connect("localhost","root","");
mysql_select_db("stp_2014");
$q="select status,price,pro_id from products where pro_id='cur1'";
$rec=mysql_query($q);
if($res=mysql_fetch_row($rec))
{
    if ($res[0]=='on' || $res[0]=='On'|| $res[0]=='ON')
