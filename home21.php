...
<td  align="right">SEARCH<input type="text" id="searchbar"  size="30" value="Search for books,stationery or other stuff.." onfocus="clear_text()"/></td>&nbsp;&nbsp;
...
<hr />
<table width="70%" border="0" height="40" align="center" bgcolor="#400080">
<tr>
<td>&nbsp;&nbsp;&nbsp;&nbsp;<input id="gobutton"  type="submit" name="btn1" value="ELECTRONICS" onclick="window.open('Electronics.php')"/>&nbsp;&nbsp;<input id="gobutton"  type="submit" name="btn1" value="BOOK & MEDIA" onclick="window.open('book.php')"/> &nbsp;&nbsp;<input id="gobutton"  type="submit" name="btn1" value="HOME & KITCHEN" onclick="window.open('inc.php')"/>&nbsp;&nbsp; <input id="gobutton"  type="submit" name="btn1" value="MORE STORE" onclick="window.open('morestore.php')"/>&nbsp;&nbsp;</td>
</tr>
</table>
<br />
...
<td align="center">
  ...
  <td>
     ...
     <img src="1.jpg" name="slide" width="700px" height="350px" style=" border-radius:20px" align="center"/>
      <script type="text/javascript">
         var step=1;
         function slideit()
         {
