...
<input id="gobutton"  type="submit" name="btn1" value="CRICKET" />
</tr>
</table>
<br /><br />
...
<tr>
<td>
<img src="c1s.jpg" width="200" height="200"/>
</td>
</tr>
<tr>
...
$q="select status,price,pro_id from products where pro_id='c1s'";
$rec=mysql_query($q);
...
<table border="0">
<tr>
<td><img src="c2s.jpg" width="200" height="200"/></td>
</tr>
<tr>
...
if(isset($_GET['b2']))
{
    $link=mysql_connect("localhost","root","");
mysql_select_db("stp_2014");
$q="select status,price,pro_id from products where pro_id='c2s'";
$rec=mysql_query($q);
if($res=mysql_fetch_row($rec))
{
    if ($res[0]=='on' || $res[0]=='On'|| $res[0]=='ON')
...
<table border="0">
<tr>
<td><img src="c3s.jpg" width="200" height="200"/></td>
</tr>
<tr>
...
if(isset($_GET['b3']))
{
    $link=mysql_connect("localhost","root","");
mysql_select_db("stp_2014");
$q="select status,price,pro_id from products where pro_id='c3s'";
$rec=mysql_query($q);
if($res=mysql_fetch_row($rec))
{
    if ($res[0]=='on' || $res[0]=='On'|| $res[0]=='ON')
...
<table border="0">
<tr>
<td><img src="c4s.jpg" width="200" height="200"/></td>
</tr>
<tr>
...
if(isset($_GET['b4']))
{
    $link=mysql_connect("localhost","root","");
mysql_select_db("stp_2014");
$q="select status,price,pro_id from products where pro_id='c4s'";
$rec=mysql_query($q);
if($res=mysql_fetch_row($rec))
{
    if ($res[0]=='on' || $res[0]=='On'|| $res[0]=='ON')
...
<tr>
<td>
<img src="c5s.jpg" width="200" height="200"/>
</td>
</tr>
<tr>
...
if(isset($_GET['b5']))
{
    $link=mysql_connect("localhost","root","");
mysql_select_db("stp_2014");
$q="select status,price,pro_id from products where pro_id='c5s'";
$rec=mysql_query($q);
if($res=mysql_fetch_row($rec))
{
    if ($res[0]=='on' || $res[0]=='On'|| $res[0]=='ON')
...
<tr>
<td>
<img src="c6s.jpg" width="200" height="200"/>
</td>
</tr>
<tr>
...
if(isset($_GET['b6']))
{
    $link=mysql_connect("localhost","root","");
mysql_select_db("stp_2014");
$q="select status,price,pro_id from products where pro_id='c6s'";
$rec=mysql_query($q);
if($res=mysql_fetch_row($rec))
{
    if ($res[0]=='on' || $res[0]=='On'|| $res[0]=='ON')
...
<tr>
<td>
<img src="c7s.jpg" width="200" height="200"/>
</td>
</tr>
<tr>
...
if(isset($_GET['b7']))
{
    $link=mysql_connect("localhost","root","");
mysql_select_db("stp_2014");
$q="select status,price,pro_id from products where pro_id='c7s'";
$rec=mysql_query($q);
if($res=mysql_fetch_row($rec))
{
    if ($res[0]=='on' || $res[0]=='On'|| $res[0]=='ON')
...
<tr>
<td>
<img src="c8s.jpg" width="200" height="200"/>
</td>
</tr>
<tr>
<td><input type="submit" name="b1" value="View"/></td>
...
if(isset($_GET['b8']))
{
    $link=mysql_connect("localhost","root","");
mysql_select_db("stp_2014");
$q="select status,price,pro_id from products where pro_id='c8s'";
$rec=mysql_query($q);
if($res=mysql_fetch_row($rec))
{
    if ($res[0]=='on' || $res[0]=='On'|| $res[0]=='ON')
    {
        /* from here price should b sent to cash page and there the user logs in or gives user name and the price is taken and order is placed.. 
        but frst status shoul dpe put as off */
    }
    else
    {
      echo '<script type ="text/javascript">alert(\'The product is already sold out!!! Please choose something else.\')</script>';
